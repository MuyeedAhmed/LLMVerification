...
static int decode_display_orientation(H2645SEIDisplayOrientation *h, const SEIRawDisplayOrientation *s)
{
    ...
    if (h->present) {
        h->flip_flag = s->display_orientation_flip_flag;
        h->rotate_flag = s->display_orientation_rotate_flag;
        h->hor_flip_flag = s->display_orientation_hor_flip_flag;
        h->ver_flip_flag = s->display_orientation_ver_flip_flag;
        h->rotation_angle = s->display_orientation_rotation_angle;
    }
